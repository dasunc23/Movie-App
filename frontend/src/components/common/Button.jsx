...
export const Button = ({ 
  ...
  const variants = {
    primary: 'bg-primary-600 hover:bg-primary-700 text-white shadow-lg hover:shadow-blue-500/50 disabled:bg-primary-800 disabled:cursor-not-allowed',
    ...
    ghost: 'text-primary-400 hover:bg-primary-600/10 disabled:text-gray-600 disabled:cursor-not-allowed',
